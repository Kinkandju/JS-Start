...
_const upperName = name.toUpperCase();_
...
_const name = 'Tirion';_

_console.log(name.length);_ // => 6
...
_name = name.toUpperCase();_

_console.log(name);_ // => TIRION
...
_const name2 = 'Shaya';_

_console.log(Math.min(name1.length, name2.length));_ // => 4