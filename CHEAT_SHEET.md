...
Область математики, в которой изучаются логические операторы, называется _булевой алгеброй_. Ниже показаны _«таблицы истинности»_ — по ним можно определить, каким будет результат применения оператора:
